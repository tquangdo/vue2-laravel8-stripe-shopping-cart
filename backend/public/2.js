...
/* harmony default export */ __webpack_exports__["default"] = ({
  methods: {
    onFormatCurrency: function onFormatCurrency(amount) {
      amount = amount / 100;
  ...
  computed: {
    v_products: function v_products() {
      return this.$store.state.state_products;
    },
    v_product: function v_product() {
      var _this = this;

      return this.v_products.find(function (product) {
          ...
          _c("div", { staticClass: "container px-12 py-24 mx-auto" }, [
            _c("div", { staticClass: "lg:w-3/5 mx-auto flex flex-wrap" }, [
              ...
              _c(
                ...
                [
                  _vm._l(_vm.v_product.categories, function(item_category) {
                    return _c("h2", {
                      key: item_category.id,
                      staticClass:
                        "text-sm title-font text-gray-500 tracking-widest uppercase inline-block mr-2",
                      domProps: { textContent: _vm._s(item_category.name) }
                    })
                  }),
                  _vm._v(" "),
                  _c("h1", {
                    ...
                    domProps: { textContent: _vm._s(_vm.v_product.name) }
                  }),
                  _vm._v(" "),
                  _c("p", {
                    staticClass: "leading-relaxed",
                    domProps: { textContent: _vm._s(_vm.v_product.description) }
                  }),
                  _vm._v(" "),
                  _c(
                    "div",
                    ...
                    [
                      _c("span", {
                        ...
                        domProps: {
                          textContent: _vm._s(
                            _vm.onFormatCurrency(_vm.v_product.price)
                          )
                        }
                      }),
                      _vm._v(" "),
