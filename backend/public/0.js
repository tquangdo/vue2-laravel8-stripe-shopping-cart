              ...
              return _c(
                ...
                [
                  ...
                  _c(
                    ...
                    { staticClass: "mt-4" },
                    [
                      _vm._l(item_product.categories, function(item_category) {
                        return _c("h3", {
                      ...
                      _c("h2", {
                        ...
                        domProps: { textContent: _vm._s(item_product.name) }
                      }),
                      _vm._v(" "),
                      _c("p", {
                        staticClass: "mt-1",
                        domProps: {
                          textContent: _vm._s(
                            _vm.onFormatCurrency(item_product.price)
                          )
                        }
                      })
                    ],
